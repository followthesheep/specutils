...
class Spectrum1D(object):
    ...
    @classmethod
    def from_array(cls, wavelength, flux, uncertainty=None,dispersion_unit = None,unit=None):
        """
        Parameters
        ----------
        ...
        return cls(out_wave, out_flux, uncertainty)
    ...
    def get_nan_cleaned(self):
        ...
        return Spectrum1D(self.wavelength[nan_filter], self.flux[nan_filter],
                            new_uncertainty)
